...
import { Box, Grid, Typography, TextField, FormControl, InputLabel, Select, MenuItem, Button, Dialog, DialogContent, ListItemIcon, ListItemText } from '@mui/material';
...
const InviteTeam = () => {
    const [teamMembers, setTeamMembers] = useState([{ name: '', email: '', role: 'Can Edit' }]);
    ...
    const handleInputChange = (index, field, value) => {
        ...
        if (field === 'email' && value !== '' && index === teamMembers.length - 1) {
            setTeamMembers([...teamMembers, { name: '', email: '', role: 'Can Edit' }]);
        }
    };
            ...
            <Grid container style={{ height: '100%', width: '100%' }}>
                ...
                >
                    <Box style={{ maxWidth: '500px', width: '100%', padding: '20px' }}>
                        <Box style={{ position: 'absolute', top: '40px', left: '50%', transform: 'translateX(-50%)', width: '100%', maxWidth: '500px', textAlign: 'left' }}>
                            <img src={pic} alt="Logo" style={{ width: '100px', marginBottom: '20px' }} />
                            <Typography variant="h1" style={{ fontFamily: 'Inter', fontSize: '36px', fontWeight: 700, marginBottom: "2rem" }}>
                                Invite Team Members
                            </Typography>
                        ...
                        {teamMembers.map((member, index) => (
                            <Box key={index} style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
                                ...
                                <TextField
                                    ...
                                    style={{ width: "32%", marginLeft: '2%', borderRadius: '8px' }}
                                    sx={{
                                        '& .MuiOutlinedInput-root': {
                                            '& fieldset': {
                                                borderRadius: '8px'
                                ...
                                />
                                <FormControl style={{ width: "32%", marginLeft: '2%' }} sx={{
                                    '& .MuiOutlinedInput-root': {
                                        '&.Mui-focused fieldset': {
                                            borderColor: '#369D9C',
                                        },
                                    ...
                                    >
                                        <MenuItem sx={{ fontFamily: "Inter" }} value="Can Edit">
                                            <ListItemIcon>
                                                <img src={check} alt="check" style={{ visibility: member.role === 'Can Edit' ? 'visible' : 'hidden', width: '24px', height: '24px' }} />
                                            </ListItemIcon>
                                            <ListItemText primary="Can Edit" />
                                        </MenuItem>
                                        <MenuItem sx={{ fontFamily: "Inter" }} value="Can View">
                                            <ListItemIcon>
                                                <img src={check} alt="check" style={{ visibility: member.role === 'Can View' ? 'visible' : 'hidden', width: '24px', height: '24px' }} />
                                            </ListItemIcon>
                                            <ListItemText primary="Can View" />
                                        </MenuItem>
                                        <MenuItem sx={{ fontFamily: "Inter" }} disabled>
                                            <hr fullWidth style={{ width: '100%', margin: '8px 0' }} />
                                        </MenuItem>
                                        {index !== 0 && (
                                            <MenuItem
                                                onClick={(e) => {
                                                ...
                                                value="Remove"
                                                style={{ color: '#EC4458', fontWeight: 500, fontSize: 11, letterSpacing: '0.026px', lineHeight: '140%', fontFamily: "Inter" }}
                                            >
                                                <ListItemIcon>
                                                    <img src={del} alt="delete" style={{ width: '24px', height: '24px' }} />
                                                </ListItemIcon>
                        ...
                        <hr style={{ border: 'none', borderTop: '1px solid #e0e0e0', marginTop: '1rem', marginBottom: '1rem' }} />
                        <button
                        ...
                        <Dialog open={open} onClose={handleClose}>
                            <DialogContent style={{ borderRadius: '10px' }}>
                                <Box style={{ textAlign: 'center', padding: '2rem 4rem 3rem 4rem', borderRadius: '10px', backgroundColor: '#FFF' }}>
                                    <img src={OnboardingCompleteSVG} alt="Onboarding Complete" width="234" height="179" />
                                    <Typography variant="h6" style={{ fontWeight: 700, fontFamily: "Inter", marginTop: '1.5rem' }}>Onboarding Complete</Typography>
                                </Box>
                            </DialogContent>
                        </Dialog>
                    </Box>
